    ...
    <div class="container">
        ...
        <form method="post" class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="input" name="name" value="<?=$project['name']?>" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">默认页面的ID</label>
                <div class="col-sm-10">
                    <input type="input" name="home_id" value="<?=$project['home_id']?>" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">链接其他项目ID</label>
                <div class="col-sm-10">
                    <input type="input" name="links" value="<?=$project['links']?>" class="form-control">
                </div>
            </div>
            <div class="form-group">
