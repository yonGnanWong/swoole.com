...
FCKLang.SyntaxhighlightBtn      = '插入代码';
FCKLang.DlgSyntaxhighlightTitle = '语法高亮';
FCKLang.SyntaxHightlightTab1 = '源代码';
FCKLang.SyntaxHightlightTab2 = '高级';

// source code tab
FCKLang.SyntaxHightlightLang = '选择语言';
FCKLang.SyntaxHightlightEnterCode = '输入源代码';

// advanced tab
FCKLang.SyntaxHightlightGutter = 'Hide gutter';
FCKLang.SyntaxHightlightGutterDetail = 'Hide gutter &amp; line numbers';
FCKLang.SyntaxHightlightNoControls = '隐藏控制面板';
FCKLang.SyntaxHightlightNoControlsDetail = '隐藏顶部的代码控制面板.';
